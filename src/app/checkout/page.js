    ...
    <>
      {
        cartItems.length > 0 ? <div className="mx-auto my-4 max-w-4xl md:my-6">
          <div className="overflow-hidden  rounded-xl shadow">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="bg-gray-100 px-5 py-6 md:px-8">
                ...
                {
                    CoupenValues.map((element, index)=><p  key={index }className="mt-4 text-sm text-gray-500 font-medium  text-left transform-uppercase">use<span className='text-96C291 font-large'> {element.coupenName}</span> for Rs {element.value} off</p>)
                }
          ...
          <h1>Do some Shopping and then Come here</h1>
          <button
            type="button"
